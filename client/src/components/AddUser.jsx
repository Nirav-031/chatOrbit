...
function AddUser({ isOpen, onClose }) {
    ...
    const fetchAllUser = async () => {
        try {
            ...
            axios.get("http://localhost:3000/fetchAll", { withCredentials: true })
                .then((result) =>
                {
    ...
    const sentFriendRequest =async (receiverId)=>
        ...
        // console.log("notification",receiverId);
            ...
            axios.post("http://localhost:3000/sendNotification", { senderID: userID.user.id, receiverID: receiverId },
             {
